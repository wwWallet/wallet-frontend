...
export interface IOpenID4VCIHelper {
	...
	getAuthorizationServerMetadata(credentialIssuerIdentifier: string, useCache?: boolean, supportedGrantTypes?: GrantsSchemaType): Promise<{ authzServerMetadata: OpenidAuthorizationServerMetadata } | null>;
