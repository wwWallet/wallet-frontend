...
import { CredentialsContextValue } from './CredentialsContext';
...
export const CredentialsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [latestCredentials, setLatestCredentials] = useState(new Set<number>());
    ...
    const contextValue: CredentialsContextValue = {
        vcEntityList,
        latestCredentials,
        fetchVcData,
        getData,
