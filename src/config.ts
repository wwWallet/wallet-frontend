...
export var OPENID4VCI_REFRESH_TOKEN_MAX_AGE_IN_SECONDS = process.env.REACT_APP_OPENID4VCI_DEFAULT_REFRESH_TOKEN_MAX_AGE_IN_SECONDS ? parseInt(process.env.REACT_APP_OPENID4VCI_DEFAULT_REFRESH_TOKEN_MAX_AGE_IN_SECONDS) : 3600;
