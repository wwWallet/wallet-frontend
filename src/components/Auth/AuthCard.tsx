...
const AuthCard = ({
	...
	return (
		<AuthPageLayout heading={
			...
			<div className="px-0 py-6 sm:p-8 sm:px-12 space-y-4 sm:space-y-6 bg-white rounded-lg dark:bg-dm-gray-900 sm:border sm:border-lm-gray-400 dark:sm:border-dm-gray-600">
				{heading && (
