...
export default function PendingTransactionsBanner({ pendingTransactions = [], onView }) {
	...
	return (
		<div
			className={`text-base group relative overflow-hidden rounded-xl border border-orange-500/20 dark:border-white/20 bg-orange-100/50 dark:bg-white/5 px-2 sm:px-5 py-2 shadow-md my-2`}
		>
			<div className="flex items-center gap-2">
				...
				<div className="min-w-0 flex-1">
					...
					<span className="hidden sm:inline-flex items-center gap-1 text-xs rounded-full border px-2 py-0.5 border-orange-300 dark:border-white/30 text-orange-600 dark:text-white/80">
